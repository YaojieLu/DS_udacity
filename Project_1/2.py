...
price_qt = price.quantile([.1, .5, 0.9], axis=1).T
...
ax1.fill_between(date, price_qt[0.10], price_qt[0.90],
                 color='b', alpha=0.2)
ax1.set_xlim([0, 365])
ax1.set_ylim([0, 1100])
...
# median daily income
ax12 = ax1.twinx()
ax12.plot(income.replace(0, np.nan).quantile([0.5], axis=1).T, color='r')
